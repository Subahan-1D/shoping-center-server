...
async function run() {
  try {
    ...
    const paymentCollection = client.db("shopingCenter").collection("payments");
    ...
    // use verify admin user after verifyToken
    ...
    // cart collection of post database
    ...
    // admin start and analytics
    app.get("/admin-stars", verifyToken, verifyAdmin, async (req, res) => {
...
app.get("/", (req, res) => {
  res.send("Shoping Center House");
});

app.listen(port, () => {
  console.log(`Shoping Center House Server: ${port}`);
});
